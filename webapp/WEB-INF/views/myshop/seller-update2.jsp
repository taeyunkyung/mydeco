									...
									<table id="a-table">
										...
										<tr>
											...
											<td><input id="prod-title" type="text" name="prodName"
												value="${productVo.prodName}"></td>
										</tr>
										<tr>
											<td><label for="prod-emo">감정</label></td>
											<td class="a-chk" id="prod-emo"
												data-emotion="${productVo.emotion}">
										...
										<tr>
											...
											<td class="a-chk" id="prod-deliv"
												data-delivery="${productVo.delivery}">
												<div class="form-radio-item">
										...
										<tr>
											...
											<td style="height: 270px;">
												...
												<div id="diary-area"
													data-added="${fn:length(productVo.prodDiaryList)}">
													<c:forEach items="${productVo.prodDiaryList}"
														var="prodDiaryVo">${prodDiaryVo.diaryNo},</c:forEach>
												</div>
											</td>
										</tr>
									</table>
