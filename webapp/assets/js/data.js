...
const qnaList = [
  {
    ...
    a: [
      ...
      { answer: 'b. 친구 있지, 절대 이성으로만 안 보일 뿐.', type: [0, 3, 6, 5, 10, 8] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. "오늘 머리도 바꾸고 옷도 새로 샀네?"라고 하며 단번에 눈치챈다.', type: [0, 3, 6, 5, 10, 8 ] },
    ]
  },
  {
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 아니 갑자기 오면 어떡해.. 하나 준비도 안 했는데 왜 와. 짜증나네.', type: [4, 9, 11] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. 연애는 마음 가는 대로! 불타오르는 연애가 최고지.', type: [2, 5, 8 ] },
    ]
  },
  {
    q: '12. 연인과 데이트 도중 화를 참을 수 없을 만큼 심하게 싸웠다. 어떻게 할 것인가?',
    a: [
