...
public class CardVo {
	...
	public CardVo(int cardNo, int userNo, String cardContent, String cardRegdate, String cardAge, String cardGender,
			int cardImgNo, String cardImgSrc, int replyCardNo, String replyContent, int replyRegdate, String targetAge,
			String targetGender, String sendYN, int count) {
		this.cardNo = cardNo;
		this.userNo = userNo;
	...
	public String toString() {
		return "CardVo [cardNo=" + cardNo + ", userNo=" + userNo + ", cardContent=" + cardContent + ", cardRegdate="
				...
				+ ", cardImgSrc=" + cardImgSrc + ", replyCardNo=" + replyCardNo + ", replyContent=" + replyContent
				+ ", replyRegdate=" + replyRegdate + ", targetAge=" + targetAge + ", targetGender=" + targetGender
				+ ", sendYN=" + sendYN + ", count=" + count + "]";
	}
